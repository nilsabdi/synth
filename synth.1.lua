...
O = {
   Template = function(self, interline, dent)
      ...
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'function indent()'
      dent = dent + 1
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'local d = 0'
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'return function(offset)'
      dent = dent + 1
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'd = d + offset'
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'return "\\n" .. dent*d'
      dent = dent - 1
      out[#out+1] = "\n" .. indent*dent
      ...
      out[#out+1] = 'end'
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'function inline(interline)'
      dent = dent + 1
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'interline[1] = true return ""'
      dent = dent - 1
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'end'
      out[#out+1] = "\n" .. indent*dent
   ...
   Segment = {
      Parse = function(self, interline, dent)
         ...
         dent = dent + 1
         out[#out+1] = "\n" .. indent*dent
         out[#out+1] = 'iter(parse_conf.ignore:trim():split(" "))'
         out[#out+1] = "\n" .. indent*dent
      ...
      Script = function(self, interline, dent)
         ...
         dent = dent + 1
         out[#out+1] = "\n" .. indent*dent
         out[#out+1] = 'local direction = script_conf.direction'
         out[#out+1] = "\n" .. indent*dent
      ...
      Output = function(self, interline, dent)
         ...
         out[#out+1] = "\n" .. indent*dent
         out[#out+1] = 'if interline[1] then out[#out+1] = dent(0) end'
         dent = dent - 1
         out[#out+1] = "\n" .. indent*dent
         out[#out+1] = 'end'
         out[#out+1] = "\n" .. indent*dent
         out[#out+1] = 'if interline[1] then out[#out] = nil end'
         out[#out+1] = "\n" .. indent*dent
         ...
         out[#out+1] = '}'
         out[#out+1] = "\n" .. indent*dent
         out[#out+1] = 'print(output(AST, false, indent()))'
         out[#out+1] = "\n" .. indent*dent
   ...
   OutputPattern = function(self, interline, dent)
      ...
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'local dent = dent or indent()'
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = 'return table.concat({'
      dent = dent + 1
      out[#out+1] = "\n" .. indent*dent
      out[#out+1] = output(assert_node(self, "chunks"), interline, dent)
      dent = dent - 1
   ...
   OutputElement = {
      Whitespace = function(self, interline, dent)
         ...
         out[#out+1] = '"'
         out[#out+1] = output(assert_node(self, "w"), interline, dent)
         out[#out+1] = '", '
      ...
      Child = function(self, interline, dent)
         ...
         out[#out+1] = 'output(assert_node(self, "'
         out[#out+1] = output(assert_node(self, "name"), interline, dent)
      ...
      Chunk = function(self, interline, dent)
         ...
         out[#out+1] = output(assert_node(self, "chunk"), interline, dent)
   ...
   LinePart = {
      Nested = function(self, interline, dent)
         ...
         out[#out+1] = '"{", '
         out[#out+1] = output(assert_node(self, "s"), interline, dent)
         out[#out+1] = '"}", '
   ...
   Bits = function(self, interline, dent)
      ...
      out[#out+1] = output(assert_node(self, "bits"), interline, dent)
